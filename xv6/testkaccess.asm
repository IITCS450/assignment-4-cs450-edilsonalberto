...
int main(void){
  ...
  volatile int x = *p;
  1d:	a1 00 00 ff ff       	mov    0xffff0000,%eax
  ...
  2b:	50                   	push   %eax
  2c:	68 3b 07 00 00       	push   $0x73b
  31:	6a 01                	push   $0x1
  33:	e8 b8 03 00 00       	call   3f0 <printf>
  exit();
  38:	e8 56 02 00 00       	call   293 <exit>
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 b0 07 00 00 	movzbl 0x7b0(%edx),%edx
 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 469:	ff 24 85 58 07 00 00 	jmp    *0x758(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 577:	90                   	nop
          s = "(null)";
 578:	ba 50 07 00 00       	mov    $0x750,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 591:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 58 0a 00 00    	mov    %edx,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 702:	00 00 00 
    if(p->s.size >= nunits){
