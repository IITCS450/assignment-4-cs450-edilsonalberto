 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 369:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 459:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba 2d 07 00 00       	mov    $0x72d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 581:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 34 0a 00 00    	mov    %edx,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 6bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 6cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	bf 38 0a 00 00       	mov    $0xa38,%edi
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 6e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 6f2:	00 00 00 
    if(p->s.size >= nunits){
