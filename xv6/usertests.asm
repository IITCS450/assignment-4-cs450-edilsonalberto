...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     2a0:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    exit();
     ...
     2ce:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     2e5:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     5de:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     5f7:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     793:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     7aa:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     7c3:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     7de:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 48 5e 00 00    	pushl  0x5e48
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 48 5e 00 00    	pushl  0x5e48
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 48 5e 00 00    	pushl  0x5e48
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    303e:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3059:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3073:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3092:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    30a9:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    30c0:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    30d7:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    30ee:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    311d:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3134:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    314b:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3162:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    322b:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3293:	ff 35 48 5e 00 00    	pushl  0x5e48
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    332a:	ff 35 48 5e 00 00    	pushl  0x5e48
    args[MAXARG-1] = 0;
    ...
    3357:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3387:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    339e:	ff 35 48 5e 00 00    	pushl  0x5e48
